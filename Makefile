...
LARGE_CORPUS_CACHE_RELEASE ?= v0.0.0-test-files
LARGE_CORPUS_CACHE_ASSET ?= shuck-cache-v3.tar.zst
LARGE_CORPUS_CACHE_SHA256 ?= 880356ce713decb75c894a488c7a5f9cbeef2e3f76e43bb04525ebab4211ccd7
LARGE_CORPUS_CACHE_URL ?= https://github.com/ewhauser/shuck/releases/download/$(LARGE_CORPUS_CACHE_RELEASE)/$(LARGE_CORPUS_CACHE_ASSET)
...
setup-large-corpus:
	SHUCK_LARGE_CORPUS_ARCHIVE_URL="$(LARGE_CORPUS_CACHE_URL)" \
	SHUCK_LARGE_CORPUS_ARCHIVE_SHA256="$(LARGE_CORPUS_CACHE_SHA256)" \
	SHUCK_LARGE_CORPUS_ARCHIVE_FILE="$(LARGE_CORPUS_CACHE_ASSET)" \
