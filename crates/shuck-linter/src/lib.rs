...
pub(crate) use rules::common::span::{
    ...
    word_unbraced_array_subscript_span, word_unbraced_variable_before_bracket_spans,
...
";
    ...
    #[test]
    fn errexit_trap_in_sh_suppressed_by_shellcheck_directive() {
        let source = "\
#!/bin/sh
...
";
    ...
    #[test]
    fn source_inside_function_suppressed_by_current_shellcheck_source_code() {
        let source = "\
#!/bin/sh
# shellcheck disable=SC3046
f() {
