...
pub use rules::common::span::{
    ...
    double_quoted_scalar_affix_span, word_all_elements_array_slice_span_in_source,
    word_all_elements_array_slice_spans, word_array_subscript_span, word_extglob_span,
