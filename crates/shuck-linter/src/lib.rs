...
pub use facts::{
    ...
    FunctionHeaderFact, GrepPatternSourceKind, LegacyArithmeticFragmentFact, LinterFacts,
    ListFact, ListOperatorFact, LoopHeaderWordFact, PathWordFact, PipelineFact,
