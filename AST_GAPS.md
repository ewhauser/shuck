...
This document tracks gaps in shuck-parser's AST that need to be addressed before building a control flow graph and dataflow analysis layer.
...
Handle in HIR lowering instead of changing the shuck-parser AST. This avoids touching the upstream parser but pushes the classification cost to every consumer.
